 ...
 */
final class Version20200520143348 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE creneau (id INT AUTO_INCREMENT NOT NULL, tournoi_id INT DEFAULT NULL, joueur_id INT DEFAULT NULL, la_date DATETIME DEFAULT NULL, duree INT DEFAULT NULL, commentaire VARCHAR(255) DEFAULT NULL, heure_debut VARCHAR(255) NOT NULL, disponibilite VARCHAR(255) DEFAULT NULL, INDEX IDX_F9668B5FF607770A (tournoi_id), INDEX IDX_F9668B5FA9E2D76C (joueur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
