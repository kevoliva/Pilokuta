 ...
 */
final class Version20200526154614 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE partie (id INT AUTO_INCREMENT NOT NULL, score_equipe1 INT DEFAULT NULL, score_equipe2 INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
